...
* 通过开放互联网、VPN 或使用外部服务（如 RealVNC 的 https://www.realvnc.com/download/viewer/[VNC Viewer]）在 Raspberry Pi 上公开 xref:remote-access.adoc#ssh[SSH] 或 xref:remote-access.adoc#vnc[VNC]。
