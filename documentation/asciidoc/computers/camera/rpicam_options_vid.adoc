...
在每个 Iframe（帧内）写入序列头。这可以帮助客户端从视频中的任意点解码视频序列，而不只是从开头解码。建议与 [`segment`](http://raspberry.dns8844.cn/documentation/computers/camera_software.html#segment)、[`split`](http://raspberry.dns8844.cn/documentation/computers/camera_software.html#split)、[`circular`](http://raspberry.dns8844.cn/documentation/computers/camera_software.html#circular) 和流媒体选项一起使用。
...
准确记录指定的帧数。任何非零值都会覆盖 [`timeout`](http://raspberry.dns8844.cn/documentation/computers/camera_software.html#timeout)。接受非零整数。
