...
本仓库包含所有用于构建 [树莓派中文文档](https://github.com/dns8844/documentation) 的工具链和文档，代码及文档均基于 [树莓派官方仓库](https://github.com/raspberrypi/documentation)。For details of how to contribute to the documentation see the [CONTRIBUTING.md](CONTRIBUTING.md) file.
